...
The Open, Aisles, and Dense presets each provide four shared docks and twelve valid spawn cells. Changing layouts performs an atomic simulation reset while preserving the selected speed and fleet size.
